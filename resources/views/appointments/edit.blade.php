...
@section('content')
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form action="{{ route('appointments.update', $news->id) }}" method="POST">
            @csrf
            @method('PATCH')
            <div class="card-body">
                <!-- EN Form -->
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="image-input image-input-empty image-input-outline" id="image_id"
                                style="background-image: url({{ find_image($news->img, 'img/news/') }})">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('authorName') ? 'is-invalid' : '' }}"
                                name="authorName" placeholder="@lang('Name')"
                                value="{{ old('authorName') ?? $news->authorName }}" required />
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="image-input image-input-empty image-input-outline" id="authorImg_id"
                                style="background-image: url({{ find_image($news->imgAuthor, 'img/news/') }})">
                                <div class="image-input-wrapper"></div>
                                <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                                    data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                                    <i class="fa fa-pen icon-sm text-muted"></i>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}"
                                name="title" placeholder="@lang('title name')" value="{{ old('title') ?? $news->title }}"
                                required />
                            @if ($errors->has('title'))
                                <div class="fv-plugins-message-container">
                                    <div class="fv-help-block">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}"
                                name="title_ar" placeholder="@lang('title name')"
